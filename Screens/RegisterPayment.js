...
export default class RegisterPayment extends Component {
  ...
  submit = async () => {
    api
      .post('/user', {
        email: this.props.registerInfo.email,
        lname: this.props.registerInfo.lname,
        fname: this.props.registerInfo.fname,
    ...
    return (
      <ScrollView>
        <View style={styles.navContainer}>
          <TouchableOpacity onPress={Actions.register} style={styles.navbutton}>
        ...
        <View style={styles.container}>
          <KeyboardAvoidingView style={styles.cockpit} behavior="padding">
            ...
            <TouchableOpacity onPress={this.submit} style={styles.button}>
              <Text style={styles.buttonText}>Setup Payment Account</Text>
            </TouchableOpacity>
          </KeyboardAvoidingView>
        </View>
      </ScrollView>
