      ...
      return (
        <TouchableOpacity
          ...
          onPress={(e) => {
            ...
            rerender.fill('md-star', 0, idx + 1);
            this.setState({stars: rerender, ratings: idx + 1}, () => {
              console.log(this.state);
            });
          }}>
          <Ionicons name={element} style={styles.star}></Ionicons>
        </TouchableOpacity>
      );
    });
    return (
      <ScrollView>
        ...
        <View style={styles.container}>
          <KeyboardAvoidingView style={styles.cockpit} behavior="padding">
            <Ionicons name="md-thumbs-up" style={styles.icon}></Ionicons>
            <View style={{flexDirection: 'row'}}>{renderedStars}</View>
            <TextInput
              onChangeText={(text) => {
