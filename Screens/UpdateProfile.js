...
export default class UpdateProfile extends Component {
  ...
  componentDidMount = async () => {
    const {fname, lname, email} = await getUser();
    this.setState({
      email,
      fname,
      lname,
    ...
    return (
      <ScrollView>
        ...
        <View style={styles.container}>
          <KeyboardAvoidingView style={styles.cockpit} behavior="position">
            <Ionicons name="md-create" style={styles.icon}></Ionicons>
            <TextInput
              onChangeText={(text) => {
